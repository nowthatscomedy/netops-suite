...
class ConfigBuilderTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.open_device_values_button = make_action_button("장비값 파일 선택", ActionKind.BROWSE)
        ...
        self.edit_profile_button = make_action_button("선택 프로파일 편집", ActionKind.EDIT)
        ...
        self.full_editor_button = make_action_button("고급 편집기 열기", ActionKind.EDIT)
