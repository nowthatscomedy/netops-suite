...
class ProfileBuilderDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        refresh_button = make_action_button("갱신", ActionKind.REFRESH, tooltip="검토 미리보기를 갱신합니다.")
    ...
    def _build_variables_tab(self) -> None:
        ...
        add_button = make_action_button("추가", ActionKind.ADD, tooltip="변수를 추가합니다.")
        add_button.clicked.connect(self.add_variable)
        remove_button = make_action_button("삭제", ActionKind.DELETE, tooltip="선택한 변수를 삭제합니다.")
    ...
    def _build_blocks_tab(self) -> None:
        ...
        left_buttons = QHBoxLayout()
        add_button = make_action_button("추가", ActionKind.ADD, tooltip="명령 블록을 추가합니다.")
        add_button.clicked.connect(self.add_block)
        remove_button = make_action_button("삭제", ActionKind.DELETE, tooltip="선택한 명령 블록을 삭제합니다.")
