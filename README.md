...
릴리즈 게시를 분리합니다. 기존 릴리즈 asset 교체는 기본적으로 차단되며, 의도적으로 교체할 때만
`allow_asset_replace`를 명시적으로 켭니다.
...
powershell -ExecutionPolicy Bypass -File .\scripts\build_release.ps1 -Version 1.0.4 -Clean -RequireCodeSigning
```
